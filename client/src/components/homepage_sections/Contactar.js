...
import useStyles from '../../styles/Contactar.module';

const Contactar = () => {
    const classes = useStyles();

    return (
        <Grid container justifyContent='center' className={classes.contactGrid} id='contactar'>
            ...
            <Grid container justifyContent='center'>
                <a href="https://www.google.com/maps/place/RINGO+BAR/@39.4845162,-0.3890558,17z/data=!3m1!4b1!4m5!3m4!1s0xd604f1cead0fce7:0xdf718751632a7a69!8m2!3d39.4845089!4d-0.3868619" target='_blank'>
                    <img src='/map_locale_01.png' alt='ubicacion de la pizzeria en mapa de formato de imagen' className={classes.imageSizeContactar} />
                </a>
